...
def main(in_file, out_dir):
    ...
    assert os.path.isfile(out_dir + '/ridge_predict_vs_true.png'), f"{out_dir}/ridge_predict_vs_true.png not found. Please check."
    assert os.path.isfile(out_dir + '/ridge_coefficients.csv'), f"{out_dir}/ridge_coefficients.csv not found. Please check." 
